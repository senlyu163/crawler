...
class A506Spider(CrawlSpider):
    name = '506'
    allowed_domains = ['wushan.gov.cn']
    start_urls = ['http://www.wushan.gov.cn/publicity_1']
    ...
    def parse_item(self, response):
        ...
        contents = response.xpath('//*[@id="content"]/div/div[1]/div').extract()
