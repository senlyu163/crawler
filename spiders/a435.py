...
class A435Spider(CrawlSpider):
    name = '435'
    allowed_domains = ['zgnj.gov.cn']
    start_urls = ['http://www.zgnj.gov.cn/njxrmzf/c102096/common_list.shtml']

    rules = (
        Rule(LinkExtractor(allow=r'/njxrmzf/c\d+/common_list\.shtml'), follow=True),
        Rule(LinkExtractor(allow=r'/njxrmzf/c\d+/\d+/.*\.shtml'), callback='parse_item', follow=True),
